...
public class TestAnimatedHitboxAttack<E extends Mob> extends DelayedBehaviour<E> {
    ...
    public TestAnimatedHitboxAttack(int delayTicks, IceElementalMob.TriggerableAnim anim, SentinelBox sentinelBox) {
        super(delayTicks);
        this.anim = anim;
        this.sentinelBox = sentinelBox;
    }

    public TestAnimatedHitboxAttack<E> attackInterval(Function<E, Integer> supplier) {
        this.attackIntervalSupplier = supplier;

        return this;
    }

    public TestAnimatedHitboxAttack<E> attackSound(SoundEvent... attackSound) {
        this.attackSounds.addAll(List.of(attackSound));

        return this;
    }

    public TestAnimatedHitboxAttack<E> attackRange(int minRange, int maxRange) {
    ...
    public TestAnimatedHitboxAttack<E> attackRange(int range) {
